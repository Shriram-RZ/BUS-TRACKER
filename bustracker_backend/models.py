...
class Route (Base ):
    ...
    start_location =Column (String (255 ),nullable =False ,comment ="Origin city/stop name")
    end_location =Column (String (255 ),nullable =False ,comment ="Destination city/stop name")
...
class Stop (Base ):
    ...
    stop_order =Column (Integer ,nullable =False ,comment ="1-based ordering along the route")
...
class Bus (Base ):
    ...
    id =Column (Integer ,primary_key =True ,index =True ,autoincrement =True )
    bus_number =Column (String (50 ),nullable =False ,unique =True ,comment ="e.g. 21A")
    route_id =Column (Integer ,ForeignKey ("routes.id",ondelete ="CASCADE"),nullable =False )
    average_speed_kmph =Column (Float ,nullable =False ,default =40.0 )

    route =relationship ("Route",back_populates ="buses")

    location =relationship ("BusLocation",back_populates ="bus",uselist =False ,
...
class BusLocation (Base ):
    ...
    id =Column (Integer ,primary_key =True ,index =True ,autoincrement =True )
    bus_id =Column (Integer ,ForeignKey ("buses.id",ondelete ="CASCADE"),nullable =False ,unique =True )
    latitude =Column (Float ,nullable =False )
    longitude =Column (Float ,nullable =False )
